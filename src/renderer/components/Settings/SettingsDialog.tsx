    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Настройки" size="md">
      ...
      {activeTab === 'appearance' && (
        <div className="space-y-4">
          ...
          {/* Kanban scale */}
          <div>
            <div className="text-xs font-medium text-t-40 mb-3 uppercase tracking-wider">Канбан</div>
            <div className="flex items-center justify-between px-3 py-2.5 rounded-lg border bg-t-03 border-t-06">
              <div>
                <div className="text-[13px] font-medium text-t-80">Масштаб колонок</div>
                <div className="text-[11px] text-t-35 mt-0.5">Ширина колонок и размер карточек</div>
              </div>
              <div className="flex items-center bg-t-06 rounded-lg p-0.5">
