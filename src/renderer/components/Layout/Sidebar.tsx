...
import { Search, Tag, RotateCcw, ChevronLeft, ChevronRight, Hand, FileText, Folder, Mail } from 'lucide-react';
...
export default function Sidebar({ collapsed, onToggle }: Props) {
  ...
  return (
    ...
    >
      {/* Toggle button */}
      <div className="flex items-center justify-end px-2 py-2.5 border-b border-white/[0.04]">
        <button
          onClick={onToggle}
          className="w-6 h-6 flex items-center justify-center rounded-md text-white/30 hover:text-white/60 hover:bg-white/[0.06] transition-all"
